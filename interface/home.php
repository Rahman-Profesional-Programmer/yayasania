...
<body>
    ...
    <div class="wrapper">
                        ...
                        <div class="header--logo text-center">
                            <h1 class="h1">
                                <a href="home.php" class="btn-link">
                                    <img src="img/logoyysn.png" alt="Ihsanul Amal Logo" width="80px">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown active">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="active"><a href="home-4.html">Home Version 04</a></li>
        ...
        <!-- <div class="posts--filter-bar style--4 hidden-xs">
            <div class="container">
                <ul class="nav">
                    <li>
                        <a href="#">
                        ...
                        <div class="row gutter--15">
                                ...
                                <div class="row gutter--15">
                                    <div class="col-md-12 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="img/world-news-img/banner-01.jpg" alt=""></a>
                                    ...
                                    <div class="col-md-12 col-xs-6 hidden-xxs">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="img/world-news-img/banner-02.jpg" alt=""></a>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"><img src="img/world-news-img/banner-03.jpg" alt=""></a>
                            ...
                            <div class="col-md-3">
                                <div class="row gutter--15">
                                    <div class="col-md-12 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="img/world-news-img/banner-04.jpg" alt=""></a>
                                    ...
                                    <div class="col-md-12 col-xs-6 hidden-xxs">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="news-single-v1.html" class="thumb"><img src="img/world-news-img/banner-05.jpg" alt=""></a>
                    ...
                    <div class="main--sidebar col-md-4 col-sm-5 ptop--30 pbottom--30" data-sticky-content="true">
                        <div class="sticky-content-inner">
                            ...
                            <div class="widget">
                                ...
                                <div class="ad--widget">
                                    <a href="#">
                                        <img src="img/ads-img/ad-300x600-1.jpg" alt="">
                                    </a>
                                </div>
                                <!-- Ad Widget End -->
                            </div>
                            ...
                            <div class="widget">
                                ...
                                <!-- Social Widget Start -->
                                <div class="social--widget style--3">
                                    <ul class="nav">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                            ...
                            <div class="widget">
                                ...
                                <div class="subscribe--widget">
                                    ...
                                    <form action="https://themelooks.us13.list-manage.com/subscribe/post?u=79f0b132ec25ee223bb41835f&id=f4e0e93d1d" method="post" name="mc-embedded-subscribe-form" target="_blank" data-form="mailchimpAjax" novalidate="novalidate">
                                        ...
                                        <button type="submit" class="btn btn-lg btn-block btn-default active">Subscribe</button>
