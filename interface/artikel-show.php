                        ...
                        <div class="sticky-content-inner">
                            ...
                            <div class="post--item post--single post--title-largest pd--30-0">
                                ...
                                <?php
                                    ...
                                    // Mengambil data dari tabel artikel
                                    $sql_author = "SELECT * FROM users WHERE email = '$penulis'";

                                    // echo var_dump($sql_author); echo "<br>";
                                    $result_author = $conn->query($sql_author);

                                   // echo var_dump($result_author); echo "<br>";
                                    ...
                                    if ($result_author->num_rows > 0) {
                                        ...
                                        while($row = $result_author->fetch_assoc()) {
                                            ...
                                            // cek anak
                                            $name_show = $row["name-show"];
                                            $foto_aut = $row["foto"];
                                            $diskripsi_aut = $row["diskripsi"];
                                            $facebook_aut = $row["facebook"];
                                            $instagram_aut = $row["instagram"];
                                            // echo var_dump($row);
                                ...
                                <div class="post--info">
                                    <ul class="nav meta">
                                        <li><a href="#"><?php echo $name_show;?></a></li>
                                        <!-- <li><a href="#"><?php echo $tanggal_terbit;?></a></li> -->
                                        <li><span><i class="fa fm fa-eye"></i>45k</span></li>
                                        <li><a href="#"><i class="fa fm fa-comments-o"></i>02</a></li>
                                    </ul>

                                    <div class="title">
                                        <h2 class="h4"><?php echo $judul_artikel; ?></h2>
                                    </div>
                                </div>

                                <div class="post--img">
                                    <a href="#" class="thumb"><img src="<?php echo $gambar;?>" alt=""></a>
                            ...
                            <div class="post--author-info clearfix">
                                    ...
                                    <div class="vc--parent">
                                        <div class="vc--child">
                                            <a href="author.html" class="btn-link">
                                                <img src="<?php echo $foto_aut;?>" alt="<?php echo $name_show;?>">
                                                <p class="name"><?php echo $name_show;?></p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="info">
                                    ...
                                    <div class="content">
                                        <p><?php echo $diskripsi_aut;?></p></p>

                                        </div>

                                    <ul class="social nav">
                                        <li><a href="<?php echo $facebook_aut; ?>"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="<?php echo $instagram_aut; ?>"><i class="fa fa-instagram"></i></a></li>
                                        <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                                        <li><a href="#"><i class="fa fa-rss"></i></a></li>
                                    </ul>
                                </div>
