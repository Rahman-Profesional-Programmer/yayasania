            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content" id="danger-pills-tabContent">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 d-flex">
                                    <div class="card border shadow-none w-100">
                                        <div class="card-body">
                                            <form class="row g-3" action="crud-edit-menu-proses.php" method="POST">
                                            ...
                                            <?php
                                                $id_edit = $_GET['id'];
                                                // echo "Nilai variabel id adalah " . $id;
                                            ?>
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT * FROM menu_utama WHERE id = $id_edit";
                                                $result = $conn->query($sql);

                                                if ($result->num_rows > 0) {

                                                    while($row = $result->fetch_assoc()) {
                                                        $urutan_edit = $row["urutan"];
                                                        $nama_edit = $row["nama_menu"];
                                                        $link_edit = $row["link_menu"]; 
                                            ...
                                            ?>
                                                ...
                                                <div class="col-12" style="display: none;"> 
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $id_edit; ?>"
                                                        name="id">
                                                </div>

                                                <div class="col-12" > 
                                                    <label class="form-label">Urutan Menu</label>
                                                    <input type="text" class="form-control" value="<?php echo $urutan_edit; ?>"
                                                        name="urutan_menu">
                                                </div>

                                                <div class="col-12">
                                                    <label class="form-label">Nama Menu</label>
                                                    <input type="text" class="form-control" Value="<?php echo $nama_edit;?>"
                                                        name="nama_menu">
                                                </div>

                                                <div class="col-12">
                                                    <label class="form-label">Link Menu</label>
                                                    <input type="text" class="form-control" Value="<?php echo $link_edit;?>"
                                                        name="link_menu">
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="d-grid">
                                                        <a href ="crud-menu.php" class="btn btn-danger">Back</a>
                                                    </div>
                                                </div>
                                                        ...
                                                        <?php
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                while($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    echo '<a class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" 
                                                                        data-bs-original-title="View detail" aria-label="Views"><i class="bi bi-eye-fill"></i></a>';
                                                                    echo '<a href="javascript:;"><i class="bi bi-pencil-fill"></i></a>';
                                                                    echo '<a class="text-danger" data-bs-toggle="tooltip" 
                        ...
                        <!-- <button class="btnEdit" data-id="1">Edit Data</button> -->
