    ...
    <div class="wrapper">
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="crud-artikel.php" class="has-arrow">
                        <div class="parent-icon"><i class="lni lni-library"></i>
                        </div>
                        <div class="menu-title">Artikel dan Label</div>
                    </a>
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" data-bs-toggle="pill" href="#menu-utama-tab" role="tab"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="tab-title">Menu Utama</div>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="pill" href="#sub-menu-tab" role="tab"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="tab-title">Sub Menu</div>
                                </div>
                            </a>
                        </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 d-flex">
                                    <div class="card border shadow-none w-100">
                                        <div class="card-body">
                                            <form class="row g-3" action="crud-add-menu-proses.php" method="POST">

                                                <div class="col-12">
                                                    <label class="form-label">Urutan Menu</label>
                                                    <input type="text" class="form-control" placeholder="Urutan Menu"
                                                        name="urutan_menu">
                                                </div>
                                                      ...
                                                      <?php
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                while($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    $enable = $row["enable"] == 1? 
                                                                            '<a onclick="disableConfirmation('.$row["id"].')" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="View detail" aria-label="Views"><i class="bi bi-eye-fill"></i></a>': 
                                                                            '<a onclick="enableConfirmation('.$row["id"].')" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="View detail" aria-label="Views"><i class="bi bi-eye-slash-fill"></i></a>'; 
                                                                    ...
                                                                    echo '<a href="crud-menu-edit-menu-utama.php?id='.$row["id"].'" 
                                                                          id="btnEdit" value=""
                                                                          class="text-warning"
                                                                    ...
                                                                    echo '<a onclick="deleteConfirmation('.$row["id"].')" class="text-danger" data-bs-toggle="tooltip" 
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    xhttp.onreadystatechange = function() {
                                        if (this.readyState == 4 && this.status == 200) {
                                            Swal.fire({icon:'success',title:'Berhasil',text:'Item berhasil dihapus.',confirmButtonColor:'#0d6efd'}).then(function(){location.reload();});
                                        }
                                    };
                                    xhttp.open("POST", "crud-del-menu-proses.php", true);
                        ...
                        <script>
                          function disableConfirmation(id) {
                            Swal.fire({
                                ...
                                text: "Apakah Anda yakin ingin menonaktifkan item ini?",
                                icon: 'warning',
                                showCancelButton: true,
                                confirmButtonColor: '#0d6efd',
                                cancelButtonColor: '#6c757d',
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    xhttp.onreadystatechange = function() {
                                        if (this.readyState == 4 && this.status == 200) {
                                            Swal.fire({icon:'success',title:'Berhasil',text:'Item berhasil dinonaktifkan.',confirmButtonColor:'#0d6efd'}).then(function(){location.reload();});
                                        }
                                    };
                                    xhttp.open("POST", "crud-disable-menu-proses.php", true);
                                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                                    xhttp.send("id=" + id);
                                }
                            });
                          ...
                          function enableConfirmation(id) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    xhttp.open("POST", "crud-enable-menu-proses.php", true);
                                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                                    xhttp.send("id=" + id);
                                }
                            });
