                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 d-flex">
                                    <div class="card border shadow-none w-100">
                                        <div class="card-body">
                                            <form class="row g-3" action="crud-edit-sub-menu-proses.php" method="POST">
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT * FROM sub_menu WHERE id = $id_edit";
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select id="pilihan" name="menu_utama" class="form-select">

                                                        <script>
                                                            // Variabel untuk nilai opsi yang akan dipilih secara otomatis
                                                            var selectedValue = "<?php echo $menu_utama; ?>";

                                                            // Fungsi untuk membuat opsi secara otomatis dan memilih opsi yang sesuai
                                                            function createOptionsAndSelect() {
                                                                ...
                                                                <?php
                                                                    ...
                                                                    if ($result->num_rows > 0) {
                                                                        while($row = $result->fetch_assoc()) {
                                                                            ...
                                                                            echo "option.value = '".$row["nama_menu"]."';";
                                                                            echo "option.text = '".$row["nama_menu"]."';";
                                                                            echo "pilihan.add(option);";

                                                                            // Jika nilai opsi sama dengan selectedValue, maka opsi tersebut akan dipilih secara otomatis
                                                                            echo "if ('".$row["nama_menu"]."' === selectedValue) {";
                                                            ...
                                                            // Panggil fungsi untuk membuat opsi dan memilih opsi secara otomatis
