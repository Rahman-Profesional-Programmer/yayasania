...
<body>
    ...
    <div class="wrapper">
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="crud-menu.php" class="has-arrow">
                ...
                <!-- <li>
                    <a href="crud-menu.php" class="has-arrow">
                        ...
                        <div class="menu-title">Artikel dan Label</div>
                    </a>
                </li> -->
                ...
                <div class="card-body">
                    <ul class="nav nav-pills nav-pills-danger mb-3" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" data-bs-toggle="pill" href="#menu-utama-tab" role="tab"
                                aria-selected="true" id="menu-uu-tama">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon"><i class='bx bx-home font-18 me-1'></i>
                                    </div>
                                    <div class="tab-title">Tambah Artikel</div>
                                </div>
                            </a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="pill" href="#sub-menu-tab" role="tab"
                                aria-selected="false" id="sub-uu-menu">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon"><i class='bx bx-user-pin font-18 me-1'></i>
                                    </div>
                                    <div class="tab-title">List Artikel</div>
                                </div>
                            </a>
                        </li>
                    ...
                    <div class="tab-content" id="danger-pills-tabContent">
                        <div class="tab-pane fade show active" id="menu-utama-tab" role="tabpanel">

                            <div class="row">
                                <div class="col-12 col-lg-12 d-flex">
                                    <div class="card border shadow-none w-100">
                                        <div class="card-body">
                                        <form class="row g-3" action="crud_artikel_proses.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                            ...
                                            <?php 
                                                ...
                                                $sql = "SELECT * FROM artikel WHERE id_artikel = $nilai_id";
                                            ...
                                            ?>
                                                ...
                                                <div class="col-12">
                                                    <label for="inputAddress4" class="col-sm-3 col-form-label">Isi Artikel :</label>
                                                    <div class="col-sm-12">
                                                        <textarea 
                                                        class="form-control" 
                                                        id="isi_artikel" 
                                                        name="isi_artikel"
                                                        rows="5" placeholder="Masukan isi artikel.." required>
                                                ...
                                                <div class="col-6">
                                                    <div class="card border shadow-none mb-3">
                                                        <div class="card-body text-center">
                                                            <img src="<?php echo $url_foto = $url_show.$gambar; ?>" 
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label">Insert Foto :</label>
                                                    <input type="file" name="foto" id="foto" accept=".jpg,.jpeg,.png" required>
                                                </div>

                                                <div class="col-12">
                                                    <label class="form-label" for="kategori">Katagori : </label>

                                                    <select name="kategori" id="kategori" class="form-select" onchange="showTextInput()" >
                                                        ...
                                                        <?php
                                                            ...
                                                            $sql_artikel = "SELECT DISTINCT kategori FROM Artikel";
                                                            // echo var_dump($sql); echo "<br>";
                                                ...
                                                <div class="col-12" id="input_kategori_baru" style="display:none;">
                                                    <label class="form-label">Masukan kategori baru :</label>
                                                    <input type="text" class="form-control" placeholder="" name="kategori_baru" >
                                                </div>

                                                <div class="mb-12">
                                                    <label class="form-label">Tag :</label>
                                                    <input type="text" class="form-control" data-role="tagsinput" name="tag" value="Pendidikan,Anak,Yayasan">
                                                </div>

                                                <div class="col-12">
                                                    <div class="d-grid">
                                                        <button class="btn btn-primary" type="submit">Save Artikel</button>
                                                    </div>
                                                </div>
                                                ...
                                                <script>
                                                    ...
                                                    function validateForm() {
                                                        ...
                                                        var inputTextDiv = document.getElementById("inputTextDiv");
                                                    ...
                                                    function showTextInput() {
                                                        var selectBox = document.getElementById("kategori");
                                                        var selectedValue = selectBox.options[selectBox.selectedIndex].value;
                                                        var inputTextDiv = document.getElementById("input_kategori_baru");
                        ...
                        <div class="tab-pane fade" id="sub-menu-tab" role="tabpanel">
                                                ...
                                                <table class="table align-middle">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <?php
                                                            ...
                                                            // Mengambil data dari tabel menu_utama
                                                            $sql = "SELECT * FROM artikel WHERE hapus = 1 ORDER BY id_artikel";
                                                            $result = $conn->query($sql);
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                while($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    $enable_artikel = $row["enable"] == 1? 
                                                                        '<a onclick="disableConfirmation('.$row["id_artikel"].')" 
                                                                        class="text-primary" 
                                                                        ...
                                                                        '<a onclick="enableConfirmation('.$row["id_artikel"].')" 
                                                                        class="text-primary" 
                                                                        data-bs-toggle="tooltip" 
                                                                        data-bs-placement="bottom" 
                                                                        title="" 
                                                                        data-bs-original-title="View detail" 
                                                                        aria-label="Views"><i class="bi bi-eye-slash-fill"></i></a>'; 

                                                                    echo '<tr>';
                                                                    echo '<td>'.$row["id_artikel"].'</td>';
                                                                    echo '<td>'.$row["judul_artikel"].'</td>';
                                                                    echo '<td>'.$row["kategori"].'</td>';
                                                                    echo '<td>'.$row["viewer"].'</td>';

                                                                    echo '<td> <div class="d-flex align-items-center gap-3 fs-6">';

                                                                    echo $enable_artikel;

                                                                    echo '<a href="crud-menu-edit-menu-utama.php?id='.$row["id_artikel"].'" 
                                                                          id="btnEdit" value=""
                                                                          class="text-warning"
                                                                          data-bs-placement="bottom" 
                                                                          title="" 
                                                                    ...
                                                                    echo '<a onclick="deleteConfirmation('.$row["id_artikel"].')" class="text-danger" data-bs-toggle="tooltip" 
                            ...
                            <div class="col-12 col-lg-4 d-flex">
                                <div class="card border shadow-none w-100">
                                    <div class="card-body">
                                        <form class="row g-3" action="crud-add-sub-menu-proses.php" method="POST">

                                            <div class="col-12">
                                                <label class="form-label">Urutan Sub Menu</label>
                                                <input type="text" class="form-control" placeholder="Urutan Sub Menu"
                                                    name="urutan_sub_menu">
                                            </div>

                                            <div class="col-12">
                                                <label class="form-label">Nama Sub Menu</label>
                                                <input type="text" class="form-control" placeholder="Nama Sub Menu"
                                                    name="nama_sub_menu">
                                            </div>

                                            <div class="col-12">
                                                <label class="form-label">Link Sub Menu</label>
                                                <input type="text" class="form-control" placeholder="Link Sub Menu"
                                                    name="link_sub_menu">
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <option>pilih menu utama</option>
                                                    ...
                                                    <?php
                                                        // Mengambil data dari tabel menu_utama
                                                        $sql = "SELECT * FROM menu_utama ORDER BY urutan";
                                                        $result = $conn->query($sql);
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button class="btn btn-primary">Add Sub Menu</button>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table align-middle">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        // Mengambil data dari tabel menu_utama
                                                        $sql = "SELECT * FROM sub_menu ORDER BY menu_utama";
                                                        $result = $conn->query($sql);
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            ...
                                                            while($row = $result->fetch_assoc()) {
                                                                ...
                                                                $enable = $row["enable"] == 1? 
                                                                        '<a onclick="disableConfirmationSub('.$row["id"].')" class="text-primary" 
                                                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="View detail" 
                                                                            aria-label="Views"><i class="bi bi-eye-fill"></i></a>': 

                                                                        '<a onclick="enableConfirmationSub('.$row["id"].')" class="text-primary" 
                                                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="View detail" 
                                                                            aria-label="Views"><i class="bi bi-eye-slash-fill"></i></a>'; 
                                                                ...
                                                                echo '<td>'.$row["link_menu"].'</td>';
                                                                echo '<td>'.$row["menu_utama"].'</td>';
                                                                echo '<td> <div class="d-flex align-items-center gap-3 fs-6">';

                                                                echo $enable;

                                                                echo '<a href="crud-menu-edit-sub-menu.php?id='.$row["id"].'" 
                                                                        id="btnEdit" value=""
                                                                        class="text-warning"
                                                                        data-bs-placement="bottom" 
                                                                        title="" 
                                                                ...
                                                                echo '<a onclick="deleteConfirmationSub('.$row["id"].')" class="text-danger" data-bs-toggle="tooltip" 
                                                                        data-bs-placement="bottom" title="" data-bs-original-title="Delete" aria-label="Delete">
                                                                        <i class="bi bi-trash-fill"></i></a>';
                                                                echo '</td></div>';
                                                                echo '</tr>';
                              ...
                              <form method="POST" action="process.php">
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    <input name="idEdit" id="idEdit" value="">

                                    <label for="nama">Urutan :</label>
                                    <input class="form-control" type="text" name="linkMenu" id="urutanMenu" value="" required>
                                  </div>

                                  <br>
                                  <div class="form-group">
                                    <label for="alamat">Nama :</label>
                                    <input class="form-control" type="text" name="linkMenu" id="namaMenu" value="" required>
                                  </div>

                                  <br>
                                  <div class="form-group">
                                    <label for="alamat">Link :</label>
                                    <input class="form-control" type="text" name="linkMenu" id="linkMenu" value="" required>
                                  </div>
    ...
    <script>
      ...
      // Mendapatkan elemen form edit
      const formEdit = document.getElementById('formEdit');
      
      // Mendapatkan elemen input id pada form edit
      const idEdit = document.getElementById('idEdit');
      
      // Mendapatkan elemen input nama pada form edit
      const namaEdit = document.getElementById('namaEdit');
      
      // Mendapatkan elemen input alamat pada form edit
      const alamatEdit = document.getElementById('alamatEdit');
      
      // Menambahkan event click pada tombol edit
      btnEdit.addEventListener('click', function() {
        // Mendapatkan id dari data yang akan diubah
        const id = this.getAttribute('data-id');
        
        // Memuat data yang akan diubah ke dalam form edit
        idEdit.value = id;
        namaEdit.value = 'Nama Data'; // Ubah dengan data yang sesuai
        alamatEdit.value = 'Alamat Data'; // Ubah dengan data yang sesuai
        
        // Menampilkan modal
        modalEdit.style.display = 'block';
      });
      
      // Menambahkan event click pada tombol close
      closeEdit.addEventListener('click', function() {
        // Menutup modal
        modalEdit.style.display = 'none';
      });
      
      // Menambahkan event submit pada form edit
      formEdit.addEventListener('submit', function(e) {
        e.preventDefault();
        
        // Mendapatkan data dari form edit
        const id = idEdit.value;
        const nama = namaEdit.value;
        const alamat = alamatEdit.value;
        
        // Kirim data ke server untuk disimpan ke dalam database
        // ...
