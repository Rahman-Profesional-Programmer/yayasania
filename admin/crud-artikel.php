                        ...
                        <!-- <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="pill" href="#danger-pills-contact" role="tab" aria-selected="false">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="tab-title">Sub Sub Menu</div>
                                </div>
                            </a>
                        </li> -->
                                    ...
                                    <div class="card border shadow-none w-100">
                                        ...
                                        <form class="row g-3" action="crud_artikel_proses.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea class="form-control" id="isi_artikel" name="isi_artikel"
                                                        rows="5" placeholder="Masukan isi artikel.." required></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6" id="input_kategori_baru" style="display:none;">
                                                      ...
                                                      <?php
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                while($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    echo '<a href="crud-artikel-edit.php?id='.$row["id_artikel"].'" 
                                                                          id="btnEdit" value=""
                                                                          class="text-warning"
                                                                          data-bs-placement="bottom" 
                                                                          title="" 
