...
<head>
  ...
  <link rel="icon" href="../interface/img/logoyysn.png" type="image/png" />
              ...
              <div class="row g-0">
                ...
                <div class="col-lg-6">
                  <div class="card-body p-4 p-sm-5">
                    ...
                    <!-- <div class="alert border-0 bg-light-danger alert-dismissible fade show py-2"><div class="d-flex align-items-center"><div class="fs-3 text-danger"><i class="bi bi-x-circle-fill"></i></div><div class="ms-3"><div class="text-danger">User atau password tidak cocok !</div></div></div><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>
                     -->
                    <form class="form-body" action="proses_login.php" method="POST">
                      ...
                      <!-- <div class="login-separater text-center mb-4"> <span>OR SIGN IN WITH EMAIL</span>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            <p class="mb-0">Don't have an account yet ? <br> Contact Support : 085281547464
